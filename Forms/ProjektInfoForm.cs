...
namespace FirebaseBackupWindowsForm.Forms
{
    public partial class ProjektInfoForm : Form
    {
        ...
        private Project observedProject;
        public ProjektInfoForm(Project project)
        {
            InitializeComponent();
            this.observedProject = new Project(project.ProjectId, project.ServiceAccountFilePath, project.LastBackupDate);
        ...
        private async void button2_Click_1(object sender, EventArgs e)
        {
            ...
            await Task.Run(() => BackupService.BackupData(observedProject, progressBar1));
        ...
        {
            await RestoreServices.RestoreData(observedProject, progressBar1);
        }
